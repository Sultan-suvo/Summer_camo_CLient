...

                        {
                            users.map((user, index) => <tr key={user._id}>
                                ...
                                <td className="flex gap-2">
                                    ...
                                    {
                                        user.role === "instructor" ? "instructor" : <button onClick={() => handleMakeInstructor(user)} className="btn btn-ghost text-white bg-blue-500"><FaChalkboardTeacher></FaChalkboardTeacher></button>
                                    }
